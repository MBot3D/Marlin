...
#define CUSTOM_MACHINE_NAME "Grid IVs"
 ...
 *    (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER -40  // -29   10  X offset: -left  +right  [of the nozzle]
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MAX_POS - 50), (Y_MAX_POS - 10), 20 }
