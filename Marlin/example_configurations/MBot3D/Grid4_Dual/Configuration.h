...
#define STRING_CONFIG_H_AUTHOR "Magicfirm" // Who made the changes.    (none, default config)
...
#define CUSTOM_MACHINE_NAME "Grid IV"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 88.89, 88.89, 400, 92.75, 92.75} //{ 80, 80, 4000, 500 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 20, 45, 45}  //{ 300, 300, 5, 25}
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000,2000, 100, 5000, 5000}  // { 3000, 3000, 100, 10000 }
...
#define Z_HOMING_HEIGHT 0  // 4  (in mm) Minimal z height before homing (G28) for Z clearance above the bed, clamps, ...
